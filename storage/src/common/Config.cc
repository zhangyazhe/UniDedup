...
//    } else if (attName == "encode.policy") {
    ...
    } else if (attName == "location.type"){
      string iffixed = ele -> NextSiblingElement("value") -> GetText();
      if (iffixed == "true") _fixedLoc = true;
    }
      else if (attName == "repair.scheduling") {
      _repair_scheduling = ele -> NextSiblingElement("value") -> GetText();
    } else if (attName == "repair.smlz.scheduling") {
      _smlz_scheduling = ele -> NextSiblingElement("value") -> GetText();
    } else if (attName == "repair.smlz.convenhanced") {
      string ifconvenhanced = ele -> NextSiblingElement("value") -> GetText();
      if (ifconvenhanced == "true") _smlz_convenhanced = true; 
    } else if (attName == "repair.smlz.rpenhanced") {
      string ifrpenhanced = ele -> NextSiblingElement("value") -> GetText();
      if (ifrpenhanced == "true") _smlz_rpenhanced = true; 
...
//         if (localitystr == "true") locality=true;
         ...
         ecpolicy->setSMLZSch(_smlz_scheduling);
         ecpolicy->setSMLZConvEnhanced(_smlz_convenhanced);
         ecpolicy->setSMLZRPEnhanced(_smlz_rpenhanced);
